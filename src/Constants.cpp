...
const Color Palette::muddyRed    = Color(0.4, 0.1, 0.1, 0.45, 0);
...
const Color Palette::crimson   = Color(0.9, 0.1, 0.3, 0.6, 0.8, 2);
const Color Palette::paleBlue  = Color(0.25, 0.3, 0.9, 0.6, 0.5, 1.5);
